...
DEBUGGING_IMAGE = 'images/20161013_210215.jpg' # filename of the image to use for capture in debuggin mode
...
ROTATION = 0 #the orientation of the camera in degrees, default is 180. If 0, entries in calibration.txt must be reversed after calibrating
